...
//             employeeModule to interact with a predefined dataset. Client may lookup by ID via "lookupByID 2"
//             "lookupByLastName Smith", and add an employee to the dataset via "addEmployee Joe Smith"
//---------------------------------------------------------------------------------
    ...
    function(socket){
        ...
        socket.on('data', function(data){
            ...
            if(dataArray[0] == 'lookupByLastName' && dataArray[1] != undefined){
                //var resp = empModule.lookupByLastName(dataArray[1]);
